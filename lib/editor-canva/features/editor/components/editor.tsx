    ...
    <div className="h-full flex flex-col">
      ...
      <div className="absolute h-[calc(100%-68px)] w-full top-[68px] flex">
        ...
        <QRSidebar
          ...
          onChangeActiveTool={onChangeActiveTool}
        />
        <main className="bg-[#f5f5f5] flex-1 overflow-auto relative flex flex-col">
          <Toolbar
            editor={editor}
            activeTool={activeTool}
            onChangeActiveTool={onChangeActiveTool}
          ...
          />
          <div className="flex-1 h-[calc(100%-124px)] bg-[#f5f5f5] relative flex items-center justify-center p-8" ref={containerRef}>
            <div 
            ...
            />
            <div className="bg-white shadow-lg rounded-lg inline-block relative z-10" style={{ boxShadow: '0 10px 40px rgba(0, 0, 0, 0.1), 0 0 0 1px rgba(0, 0, 0, 0.08)' }}>
