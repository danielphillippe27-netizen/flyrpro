...
const roofingCopy: IndustryCopy = {
  ...
  campaigns: {
    ...
    selectDescription: 'Choose a roofing campaign from the list or create a new one to start booking appointments.',
    ...
    namePlaceholder: 'Spring roof appointment route',
    generatingTitle: 'Generating Roofing Campaign',
  },
  leads: {
    ...genericCopy.leads,
    pageTitle: 'Leads',
    pageDescription: 'Manage homeowner leads from imports, roofing campaigns, and service areas, then send the right group to the dialer.',
    allListName: 'All Roofing Leads',
    ...
    totalLabel: 'Total roofing leads',
    newThisWeekLabel: 'New leads this week',
    conversionRateLabel: 'Conversation-to-lead rate',
    loading: 'Loading roofing leads...',
    empty: 'No roofing leads match your filters.',
    selectAllAria: 'Select all visible roofing leads',
    ...
    newSavedListDescription: 'Save a reusable lead view when you want to keep a segment around outside of imports, roofing campaigns, or service areas.',
  ...
  contactDialog: {
    ...
    description: 'Add a new roofing lead',
  ...
  importDialog: {
    title: 'Import Roofing Leads from CSV',
    description: "Upload a CSV and we'll create homeowner leads in this workspace. Common lead headers are mapped automatically.",
    listNamePlaceholder: 'Storm damage appointment list',
