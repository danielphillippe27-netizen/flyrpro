...
export function PricingCard({
  ...
  return (
    <article className="flex flex-col rounded-3xl border border-zinc-200 bg-white p-5 shadow-sm md:p-6">
      {badge && (
      ...
      <p className="mt-2 text-base leading-relaxed text-zinc-700">{subtitle}</p>
      {priceDisplay != null && <div className="mt-5">{priceDisplay}</div>}
      <ul className="mt-5 space-y-2.5 text-base text-zinc-800">
