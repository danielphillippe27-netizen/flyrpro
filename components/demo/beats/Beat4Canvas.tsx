...
export type RepName = 'MARCUS' | 'DEVON' | 'PRIYA' | 'COLE';
export type OutcomeClass = 'ok' | 'nh' | 'dk';
...
export const NAMES: [RepName, string][] = [
  ['MARCUS', '#5ab4ff'],
  ['DEVON', '#ff4d00'],
  ['PRIYA', '#27c878'],
  ['COLE', '#ffb000'],
];
export const STREETS = ['Birch St', 'Larkspur Crt', 'Mason Ave', 'Hilltop Rd', 'Quarry Ln', 'Fenwick Dr', 'Aspen Gate'];
export const OUTCOMES: [string, OutcomeClass, number][] = [
  ['INTERESTED', 'ok', 0.22],
  ['NOT HOME', 'nh', 0.42],
  ['NO ANSWER', 'nh', 0.22],
  ['DO NOT KNOCK', 'dk', 0.14],
];
export const OUTCOME_COLORS: Record<OutcomeClass, string> = { ok: '#27c878', nh: '#ffb000', dk: '#e53935' };
...
export function makePath(city: DemoCity, rng: () => number) {
  const pts: number[][] = [];
...
export function Beat4Canvas({ copy }: { copy: BeatCopy }) {
