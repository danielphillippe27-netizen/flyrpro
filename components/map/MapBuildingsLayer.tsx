...
export function MapBuildingsLayer({ map, campaignId, statusFilters = defaultStatusFilters, showOrphans = true, onBuildingClick, onAddToCRM }: MapBuildingsLayerProps) {
  ...
  // Campaign and non-campaign both use status-based colors: red = untouched, green = visited, blue = hot, purple = QR scanned.
  const getColorExpression = (): any => {
    ...
    return [
      ...
      // UNTOUCHED (default): status === 'not_visited' or fallback — red for new/untouched campaign buildings
