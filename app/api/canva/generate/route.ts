...
function generateReadme(
  ...
  return `================================================================================
WolfGrid - CANVA BULK QR CODE PACKAGE
================================================================================
...
Tracking URL format:
https://wolfgrid.app/api/scan?campaignId=${campaignId}&address=...

Scan data will appear in your WolfGrid campaign dashboard.
...
NEED HELP?
----------
Contact WolfGrid support or visit your campaign dashboard at:
https://wolfgrid.app/campaigns/${campaignId}

================================================================================
Generated by WolfGrid - Smart Marketing for Real Estate
================================================================================
`;
}
