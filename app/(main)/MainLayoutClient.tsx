...
import { Home, Map, Trophy, Users, Settings, Target, Gauge, Plug, CreditCard, MessageCircle, Shield, Activity, CalendarDays, Clock3 } from 'lucide-react';
...
const baseTabs = [
  ...
  { href: '/follow-up', icon: Clock3, label: 'Follow Up' },
