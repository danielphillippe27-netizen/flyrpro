-- Make rpc_get_campaign_full_features resilient to deployments where
-- public.buildings.source is absent and where address_statuses may use either
-- campaign_address_id or (address_id, campaign_id) linkage.
...
'Returns a GeoJSON FeatureCollection for a campaign across gold, campaign-scoped, manual, and free address-point features without depending on public.buildings.source.';
