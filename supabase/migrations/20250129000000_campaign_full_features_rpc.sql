-- Campaign-Wide Persistence: Full Campaign Features RPC
-- Fetches ALL features for a campaign without viewport filtering
...
BEGIN
    ...
    FROM (
        ...
        -- No bbox filtering - fetch entire campaign
        -- No LIMIT - campaigns are typically 100-1000 features (tiny payload)
    ) features;
...
'Returns complete GeoJSON FeatureCollection for a campaign without viewport filtering. Enables "fetch once, render forever" for smooth pan/zoom without edge clipping. Use this for campaign detail views; use rpc_get_campaign_map_features for general exploration.';
