-- Use the campaign boundary as a selector for parcels, not as a clipping mask.
-- If any part of a parcel intersects the campaign polygon, the map should render
-- the full parcel footprint.
