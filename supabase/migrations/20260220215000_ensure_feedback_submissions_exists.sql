-- Heal migration: ensure web feedback table exists in environments where
-- 20260218234000_feedback_submissions.sql was not applied.
-- Fixes: "Could not find the table 'public.feedback_submissions' in the schema cache"
...
-- Prompt PostgREST/Supabase API to refresh schema cache immediately.
